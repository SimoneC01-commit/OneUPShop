...
public class ConnectionPool {
    ...
    static {
        ...
        try (InputStream input = ConnectionPool.class.getResourceAsStream("/db.properties")) {
            if (input == null) {
                System.err.println("[ConnectionPool] ATTENZIONE: File 'db.properties' non trovato nel classpath!");
            ...
            System.err.println("[ConnectionPool] Errore durante la lettura di 'db.properties'");
            ex.printStackTrace();
        }
    }
    ...
    public static synchronized void init(int poolSize) throws SQLException {
        ...
        INITIAL_POOL_SIZE = poolSize > 0 && poolSize <= MAX_POOL_SIZE? poolSize : INITIAL_POOL_SIZE;
    ...
    private static Connection createDBConnection() throws SQLException {
    	if (JDBC_URL == null || JDBC_URL.isEmpty()) {
            throw new SQLException("[ConnectionPool] Credenziali mancanti. Verifica il file db.properties.");
        }
